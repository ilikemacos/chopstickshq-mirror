#!/bin/bash
# Fathom installer v0.2.8-Beta — IOReport package watts + sleep/wake drain events
set -Eeuo pipefail
IFS=$'\n\t'
umask 077
...
EXPECTED_HASH="e11620641ec0858f799476e20cbca82ae231c5867bb24af4da9d88916c42ebed"
...
let FATHOM_VERSION = "v0.2.8-Beta"
