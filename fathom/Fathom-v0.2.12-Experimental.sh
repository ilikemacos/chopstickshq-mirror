#!/bin/bash
# Fathom installer v0.2.12-Beta — responsive menubar + history + alerts + rNitro link
set -Eeuo pipefail
IFS=$'\n\t'
umask 077
...
EXPECTED_HASH="4353f8ea316bcb81e317f3e674b1a51cdad24bb2d43eb2648d318850689aeba8"
...
let FATHOM_VERSION = "v0.2.12-Beta"
    ...
    private func poll() {
        DispatchQueue.global(qos: .utility).async { [weak self] in
            ...
            DispatchQueue.main.async {
                ...
                // chronological last filled samples
                var hist: [Double] = []
...
struct MainRoot: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            // Package-watts sparkline (~1h history when warm)
