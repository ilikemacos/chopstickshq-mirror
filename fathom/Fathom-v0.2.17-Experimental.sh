#!/bin/bash
# Fathom installer v0.2.17-Beta — UX friendliness pass
set -Eeuo pipefail
IFS=$'\n\t'
umask 077
...
EXPECTED_HASH="3cc949da70bd59e84dba81adad096a968cfef58a6c98f6751e16fceac233ede8"
...
let FATHOM_VERSION = "v0.2.17-Beta"
