#!/bin/bash
# Fathom installer v0.2.10-Beta — mock-identical dashboard
set -Eeuo pipefail
IFS=$'\n\t'
umask 077
...
EXPECTED_HASH="deb93be7803a5369f6045f42c05aa55ed13f5df032bfcee2c23c3afc81c2e6c5"
...
let FATHOM_VERSION = "v0.2.10-Beta"
