...
EXPECTED_HASH="19cba52d15da91d7d132714082e5a520e616a21caeb1346675aa713b68270b99"
...
let FATHOM_VERSION = "v0.2.1-Beta"
...
extension Color {
    ...
    static let bg = adaptive(light: rgb(0.96, 0.96, 0.98), dark: rgb(0.05, 0.05, 0.08))
    static let card = adaptive(light: rgb(1.0, 1.0, 1.0), dark: rgb(0.10, 0.10, 0.14))
    static let border = adaptive(light: rgb(0.82, 0.84, 0.90), dark: rgb(0.20, 0.20, 0.28))
