#!/bin/bash
# Fathom installer v0.2.15-Beta — menubar % + time
set -Eeuo pipefail
IFS=$'\n\t'
umask 077
...
EXPECTED_HASH="44f5f34b53fc14da916797c1c1f032869534416bcfbd905809691f73bacee844"
...
let FATHOM_VERSION = "v0.2.15-Beta"
...
<key>CFBundleVersion</key><string>0.2.15</string>
