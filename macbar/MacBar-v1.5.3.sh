...
EXPECTED_HASH="27d4dbad8b234d0d85efcd383a34d4157d838ea28dc25d2c3fa46a98d772e855"
...
struct MiniGraphView: View {
    ...
    var body: some View {
        ...
        .animation(MacBarMotion.bar, value: history.last)
    }
}
...
final class AIChatModel: ObservableObject {
    ...
    nonisolated private static func requestChopsticks(messages: [ChatMessage], tier: String, accessToken: String?) async -> String {
        ...
        req.setValue("MacBar/1.5.3", forHTTPHeaderField: "User-Agent")
...
struct ContentView: View {
    ...
    private var rootContent: some View {
        ...
        .clipShape(RoundedRectangle(cornerRadius: layout == .popover ? MacBarMotion.panelCorner : 0, style: .continuous))
    }
