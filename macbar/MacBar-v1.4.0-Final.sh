...
enum ChopsticksAIKB {
    ...
    static let intents: [ChopsticksAIIntent] = [
        ...
        ChopsticksAIIntent(
            ...
            priority: 70,
            answer: "No. chopsticksAI runs locally — in your browser on the website, and on-device inside MacBar.\n\nYour questions are never uploaded, logged, or sent to any server. There's no account, no cookie tracking, and no analytics on what you ask.\n\nThe same applies to the apps: MacBar and Fathom send no usage telemetry.",
...
enum AIProvider: String, CaseIterable, Identifiable {
    ...
    var setupHint: String {
        ...
        case .chopsticks, .chopsticksSuper:
            return "chopsticksAI is built in. It answers from an on-device knowledge base about MacBar, Fathom and ARENA - no API key, no network request, nothing leaves your Mac."
        case .lmStudio:
