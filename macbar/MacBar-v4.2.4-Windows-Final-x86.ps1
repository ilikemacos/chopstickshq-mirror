...
#
# v6.1.1a — Fixed update prompt to always open macbar.netlify.app after OK.
#
# v6.0.1b — Added update checker on launch: compares against version.json on
# macbar.netlify.app (uses the "windows" field) and opens the site to download
...
static class UpdateChecker {
    ...
    const string VersionUrl     = "https://macbar.netlify.app/version.json";
    const string DownloadPage   = "https://macbar.netlify.app";
