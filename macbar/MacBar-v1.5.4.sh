...
EXPECTED_HASH="5d85bae0d84f72a869b91c7936db0e0359d4ce4b9cbadb4b533a54100537bbf5"
...
final class AIChatModel: ObservableObject {
    ...
    nonisolated private static func requestChopsticks(messages: [ChatMessage], tier: String, accessToken: String?) async -> String {
        ...
        req.setValue("MacBar/1.5.4", forHTTPHeaderField: "User-Agent")
...
<dict>
    ...
    <key>CFBundleVersion</key><string>1.5.4</string>
